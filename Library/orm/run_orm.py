        ...
        while True:
            ...
            if choice == "1":
                ...
                if not DBBackend.book_exists(book_id):
                    ...
                    DBBackend.get_book_data(book_id)
                ...
                if not DBBackend.book_exists(book_id):
                    ...
                    publication_year = input("Новый год публикации: ")
                    if publication_year == "":
                ...
                DBBackend.get_authors_list()

            elif choice == "4":
                DBBackend.get_genres_list()
                ...
                DBBackend.get_books_by_author_name(author_name)

            elif choice == "8":
                genre_name = input("Введите название жанра для поиска книг: ")
                DBBackend.get_books_by_genre(genre_name)

            elif choice == "9":
                request = input("Введите запрос для поиска совпадений: ")
                DBBackend.get_books_by_some_match(request)
